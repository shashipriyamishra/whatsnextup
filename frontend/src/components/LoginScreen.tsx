  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black/90 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-96 h-96 bg-pink-600/30 rounded-full blur-3xl animate-pulse"
        ...
        ></div>
        <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-pink-500/20 rounded-full blur-3xl opacity-50"></div>
      </div>
