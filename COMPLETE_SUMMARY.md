...
```
Value 1: GEMINI_API_KEY = AIzaSyC31ANIJyGbetkPzbzXTUbXsRwtD2w8BAA
Value 2: GCP_PROJECT_ID = whatsnextup-d2415
```

**File #2:** `/Users/shashipriyamishra/Documents/GitHub/whatsnextup/frontend/.env.local`
```
Value 3: NEXT_PUBLIC_API_BASE = https://whatsnextup-api-214675476458.us-central1.run.app
Value 4: NEXT_PUBLIC_FIREBASE_API_KEY = AIzaSyCUr9df-M0IMnm_7GLBa3igZ4dpPH02SRw
```
